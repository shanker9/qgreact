...
export default class TableController {
    ...
    getDefaultViewData(startIndex, endIndex, rowHeight) {
        let topDivHeight, bottomDivHeight;
        return { gridDataSource:this.appDataModel.getDefaultData(), topDivHeight, bottomDivHeight };
    ...
    getGroupedViewData(startIndex, endIndex, rowHeight) {
        let topDivHeight, bottomDivHeight;
        return { gridDataSource:this.appDataModel.getGroupedViewData(), topDivHeight, bottomDivHeight };
        // let adjustedStartIndex = startIndex > 10 ? (startIndex - 10) : 0;
